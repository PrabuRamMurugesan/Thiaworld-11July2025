...
const dummyContent = {
  ...
  description:
    "A powerful AI-powered care plan that includes diagnostics, OPD, and emergency support.",
      ...
      <div className="d-flex" style={{ minHeight: "100vh" }}>
        ...
        <div style={{ width: `calc(100% - ${sidebarWidth}px)` }}>
          ...
          <main>
            <Container
              fluid
              className={`p-5 ${darkMode ? "bg-dark text-light" : ""}`}
            >
              <Row className="align-items-center mb-3">
                <Col md={8}>
                  <h4>🧠 CMS Advanced Admin Panel</h4>
                  <small className="text-muted">
                    Manage content workflow, editing, history, analytics,
                    ...
                    <Card.Body>
                      <Form>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            type="text"
                            defaultValue={dummyContent.title}
                          />
                        </Form.Group>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            as="textarea"
                            rows={4}
                            defaultValue={dummyContent.description}
                          />
                        </Form.Group>
                        <Form.Group className="mb-3">
                ...
                >
                  <Card className="mb-3">
                    <Card.Body>
                      ...
                      <ul>
                        <li>
                          v5 – Updated CTA and keywords – <em>by admin</em>
                        </li>
                        <li>
                          v4 – Added new image – <em>by designer</em>
                        </li>
                        <li>
                          v3 – Initial Arabic translation –{" "}
                          <em>by translator</em>
                        </li>
                      </ul>
                ...
                >
                  <Card className="mb-3">
                    <Card.Body>
                      ...
                      <p className="mt-3">
                        💡 Tip: Publish on weekday mornings for max visibility.
                      </p>
                    </Card.Body>
                  </Card>
                </Tab>
                  ...
                  <Card className="mb-3">
                    <Card.Body>
                      <Form>
                        <Form.Group>
                          <Form.Label>
                            Upload Media (auto WebP + compress)
                          </Form.Label>
                ...
                >
                  <Card className="mb-3">
                    <Card.Body>
                      ...
                      <p>
                        “Try shorter title. Add location in keyword. Consider
                        linking to Form Builder.”
                      </p>
                ...
                >
                  <Card className="mb-3">
                    <Card.Body>
                      ...
                      <ul className="small">
                        <li>
                          [2025-07-14 15:12] admin@bbs – Edited Plan Title
                        </li>
                        <li>
                          [2025-07-13 10:44] designer@bbs – Uploaded banner.jpg
                        </li>
                      </ul>
