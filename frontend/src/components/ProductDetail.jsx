...
const ProductDetailPage = () => {
  ...
  const fetchProduct = async () => {
    ...
    setProduct(prod);
    setSelectedImage(`http://localhost:5000${prod.images[0]}`);
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
            <div className="bg-yellow-50 border border-yellow-300 p-4 rounded">
              ...
              <p className="text-sm mb-2">
                Speak with our expert jeweller directly and examine the piece in
                real-time over a video call.
              </p>
            ...
            <div className="bg-green-50 border border-green-300 p-4 rounded">
              ...
              <p className="text-sm mb-2">
                Have questions? Chat with our support team anytime on WhatsApp.
              </p>
