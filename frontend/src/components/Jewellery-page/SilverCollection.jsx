  ...
  return (
    <>
      ...
      <div className="bg-white min-h-screen ">
        ...
        >
          Home / Jewellery /{" "}
          <span className="text-yellow-600 ">Silver Collection</span>
        </div>
            ...
            >
              ...
              <div className="mt-2">
                ...
                {prod.isSecurePlanEnabled && (
                  <div className=" mt-1 inline-block bg-green-100 text-green-800 px-2 py-0.5 rounded-full">
                    Secure Plan
                  </div>
                )}
                {prod.isPartialPaymentEnabled && (
                  <div className=" mt-1 inline-block bg-yellow-100 text-yellow-800 px-2 py-0.5 rounded-full ml-1">
                    Partial Pay
                  </div>
                )}
                {prod.isCombo && (
                  <div className=" mt-1 inline-block bg-purple-100 text-purple-800 px-2 py-0.5 rounded-full ml-1">
                    Combo
                  </div>
                )}
