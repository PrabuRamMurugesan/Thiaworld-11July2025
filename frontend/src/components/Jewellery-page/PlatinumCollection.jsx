  ...
  const fetchPlatinumProducts = async () => {
    try {
      ...
      const res = await axios.get(
        `${API}/api/products/platinum?${query.join("&")}`
      );
          ...
          >
            ...
            <div className="d-flex flex-row align-items-center gap-2">
              ...
              <div className="d-flex flex-row gap-3 text-gray-600">
                {["Bracelets", "Chains", "Couple Bands"].map((cat) => (
          ...
          {products.map((prod) => (
            ...
            >
              ...
              <div className="mt-2">
                ...
                <div className="mt-1 text-blue-700 font-bold text-md">
                  ₹{prod.price}{" "}
                  {prod.discount > 0 && (
                ...
                <div className="mt-2 flex gap-2">
                  <button
                    ...
                    className="flex-1 text-xs text-blue-600 border border-blue-600 rounded px-2 py-1 hover:bg-blue-50"
                  >
                    👁 Try This On
                  </button>
                  <button
