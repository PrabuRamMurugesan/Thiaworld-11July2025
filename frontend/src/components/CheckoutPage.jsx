...
const CheckoutPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const saveRes = await axios.post(`${API}/api/checkout/submit`, {
      ...
      const options = {
        key: import.meta.env.env.VITE_RAZORPAY_KEY_ID,
        amount: order.amount,
        currency: "INR",
        ...
        handler: async function (response) {
          await axios.post(`${API}/api/checkout/update-payment-status`, {
    ...
    <>
      <div className="container mx-auto my-8  p-5 border">
        ...
        >
          ...
          {/* Billing */}
          <div>
            <h3 className="text-lg font-semibold  d-flex justify-between">
              Billing Address
        ...
        <div className="my-8">
          ...
          <h3
            className="font-semibold mb-2mt-4"
